...
<div class="content">
    <table width=100 style="table-layout: fixed" border="1" class="table table-striped table-bordered">
        ...
        <tr>
            <td>글제목</td>
            <td colspan="7"><%=bb.getSubject()%>
            </td>
        </tr>
        <tr>
            <td>첨부파일</td>
            <td colspan="3">
                미리보기: <a href="../upload/<%=bb.getFile()%>"><%=bb.getFile()%>
            </a>
            </td>
            <td colspan="4">
                다운로드: <a href="filedown.jsp?file_name=<%=bb.getFile()%>"><%=bb.getFile()%>
            </a>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="7">
                <div class="mb-3">
  						<textarea style="resize: none;" class="form-control" name="content" rows="20" cols="100"
                                  readonly="readonly">
  						<%=bb.getContent()%>
  						</textarea>
                </div>
