    ...
    <div class="contents_view">
                ...
                <tr>
                    <td colspan="4" height="200" valign="top" style="padding:20px; line-height:160%;">
                        <div id="bbs_file_wrap">
                            <div>
                                <img class="view_img" src="../upload/<%=filename %>"
                                     style="margin-left: 250px;  width:800px; height: 1000px; " onerror=""/><br/>
                            </div>
                        </div>
        ...
        <div class="btn_area">
            <div class="align_left">
                <input type="button" value="목록으로" class="btn_list btn btn-dark" style="cursor: pointer;"
                       onclick="location.href='board_list1.jsp?cpage=<%=cpage %>'"/>
            </div>
            <div class="align_right">
                <c:if test="${id.equals(name)}">
                    <input type="button" value="수정하기" class="btn_list btn btn-dark" style="cursor: pointer;"
                           onclick="location.href='board_modify1.jsp?cpage=<%=cpage %>&seq=<%=seq %>'"/>
                    <input type="button" value="삭제하기" class="btn_list btn btn-dark" style="cursor: pointer;"
                           onclick="location.href='board_delete1.jsp?cpage=<%=cpage %>&seq=<%=seq %>'"/>
                </c:if>
                <input type="button" value="글쓰기" class="btn_write btn btn-dark" style="cursor: pointer;"
