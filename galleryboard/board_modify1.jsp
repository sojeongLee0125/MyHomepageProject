        ...
        <div class="contents_sub" style="padding-bottom: 100px;">
                ...
                <table>
                    <tr>
                        ...
                        <td class="top" colspan="3">
                            <input type="text" name="name" value="<%=name %>" class="form-control" maxlength="5"
                                   readonly/>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="btn_area" style="padding-right: 450px; padding-left: 450px;">
                <div class="align_left">
                    <input type="button" value="목록으로" class="btn btn-dark" style="cursor: pointer;"
                           onclick="location.href='board_list1.jsp?cpage=<%=cpage %>'"/>
                    <input type="button" value="원글보기" class="btn btn-dark" style="cursor: pointer;"
                           onclick="location.href='board_view1.jsp?cpage=<%=cpage %>&seq=<%=seq %>'"/>
                </div>
                <div class="align_right">
                    <input type="button" value="수정하기" id="submit1" class="btn_write btn btn-dark"
